...
const LEADERS = [
  { role: 'President', name: 'Tanishqa Giri', initials: 'TG', img: tanishqaImg, scale: 4.2, x: '0%', y: '-8%', linkedin: 'https://www.linkedin.com/in/tanishqa-giri-b29a15260/' },
  ...
  { role: 'Secretary', name: 'Simran Jaiswal', initials: 'SJ', img: simranImg, scale: 1.15, x: '0%', y: '-4%', linkedin: 'https://www.linkedin.com/in/simran-jaiswal-62ba4b2b7/' },
]
